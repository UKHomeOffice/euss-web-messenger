...
describe('ViewCookies', () => {
  ...
  test('renders cookie information and headings', () => {
    renderWithRouter(<ViewCookies />, { state: { cookiePolicy: 'euss_cookie_policy' } });
  ...
  test('sets useCookies to true if cookie value is "true"', () => {
    ...
    expect(Cookies.get).toHaveBeenCalledWith('euss_cookie_policy');
  });
  ...
  test('calls updateCookieSettings with true when useCookies is true', async () => {
    ...
    expect(updateCookieSettings).toHaveBeenCalledWith('euss_cookie_policy', true);
  });
  ...
  test('calls updateCookieSettings with false when useCookies is false', async () => {
    ...
    expect(updateCookieSettings).toHaveBeenCalledWith('euss_cookie_policy', false);
  });
