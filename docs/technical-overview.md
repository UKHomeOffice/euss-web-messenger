...
This document provides a developer-focused, end-to-end technical overview of the `euss-web-messenger` project: key dependencies and versions, how environment configuration flows from the container into the built SPA, how to run locally and in Docker, the project layout, and how errors are surfaced/handled.
